...
export const QIANTANG_NANHU_HOTEL=['嘉兴南湖桔子水晶酒店','2026-09-24','2026-09-25','0573-82091333','嘉兴市南湖区东栅街道辰溪里7号楼','高级双床房 1间；26㎡；2张1.2*2米床；外景窗；早餐赠1份（限金会员入住）','1','在线付 ¥322.32','与另一家嘉兴酒店同夜'];
export const QIANTANG_ATOUR_HOTEL=['嘉兴月河历史街区中山路亚朵酒店','2026-09-24','2026-09-25','','嘉兴市南湖区建设街道中山东路699号','','1','已授权离店后付 ¥347','携程订单 1128150964876747；房间已预留，到店报住客姓名并出示证件即可入住；入住 14:00后、离店 14:00前；9月24日12:00前免费取消；与另一家嘉兴酒店同夜'];
export const QIANTANG_HANTING_HOTEL=['汉庭海宁盐仓酒店','2026-09-25','2026-09-26','','海宁市长安镇盐仓农发区锦带湾广场20号','高级双床房 1间；25-30㎡；2张1.2*2米床；外景窗；早餐赠1份（限金会员入住）','1','在线付 ¥315.92','入住 12:00、离店 14:00；9月25日 20:00前可免费取消'];

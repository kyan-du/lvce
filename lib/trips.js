...
export const QIANTANG_TRIP_MIGRATION='qiantang-trip-20260925-v4-jiaxing-day';
...
export const QIANTANG_ITINERARY_ROWS=[['2026-09-24','17:23-17:53','G1347 上海南→嘉兴南','上海南／嘉兴南','胡丽霞','铁路（4张）；订单号 E292090250；检票口5A5B；下单 2026.09.14。'],['2026-09-24','入住后／晚饭','入住嘉兴南湖桔子水晶酒店','嘉兴南湖桔子水晶酒店','胡丽霞','实际入住南湖桔子水晶，含早餐。当晚只吃饭，有余力再就近看月河，不排夜游。'],['2026-09-25','','嘉兴博物馆（起点）','嘉兴博物馆','胡丽霞','四人含两孩；本日嘉兴市区游起点。'],['2026-09-25','','南湖革命纪念馆','南湖革命纪念馆','胡丽霞','约2.4km，打车/骑行。南湖段建议：纪念馆→勺园→会景园码头→上船，少回头。'],['2026-09-25','','午饭：真真老老·会景园店','海盐塘路（南湖船菜大酒店东约50米）','胡丽霞','一笼烧卖+两只粽子；纪念馆出来后、会景园码头上船前。'],['2026-09-25','','会景园码头坐船→湖心岛','会景园码头／湖心岛（烟雨楼、红船）','胡丽霞','上船后游览烟雨楼、红船。'],['2026-09-25','','子城遗址公园','子城遗址公园','胡丽霞','下岛后打车/骑行；湖心岛到子城约3.8km用车。'],['2026-09-25','','天主堂（外观打卡）','嘉兴天主堂','胡丽霞','步行约350m；外观打卡即可。月河今晚已去；天主堂后可选、非必须。'],['2026-09-25','18:02-18:17','G7305 嘉兴南→海宁西','嘉兴南／海宁西','胡丽霞','铁路（3张）；胡丽霞、杜万、杜暄妍；杜明远免票随行。订单号 E227044392；检票口二层检票口。海宁西在许村，不是海宁站。'],['2026-09-25','到店后','入住汉庭海宁盐仓酒店','长安镇锦带湾／老盐仓附近','胡丽霞','高级双床房 1间；在线付 ¥315.92。18:17 到海宁西，下午潮基本赶不上；当晚可靠近塘，主场在 26 日白天老盐仓。'],['2026-09-26','白天；提前 60-90 分钟到塘','老盐仓观潮','老盐仓丁字坝','胡丽霞','看一线潮与回头潮。精确来潮钟点以当日海宁潮汛／景区广播为准，不把参考潮时写成列车时刻。不下水、不站丁字坝外侧。带望远镜×2。不去盐官、八堡。'],['2026-09-26','按 19:42 发车倒推','前往海宁站（硖石）','老盐仓→海宁站','胡丽霞','C406 从海宁站发车，不是海宁西。西站（许村）与硖石约 30 公里，不要跑错站。'],['2026-09-26','19:42-20:54','C406 海宁→上海南','海宁／上海南','胡丽霞','铁路（4张）；订单号 E275946591；候车室 01；下单 2026.09.17。']];

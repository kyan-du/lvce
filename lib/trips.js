...
export const ZHANGJIAJIE_ITINERARY_MIGRATION='zhangjiajie-itinerary-20260805-v3';
...
['2026-08-05','09:00集合；09:30-12:30','湖南博物院 3 小时重点游览','湖南博物院','胡丽霞','订单事实：09:30场、09:00馆外集合、共4人凭身份证。路线：入口→马王堆汉墓陈列（重点）→辛追夫人→T型帛画→素纱襌衣→湖南历史文化展→青铜器。不要一进去就从一楼慢慢看，避免提前消耗体力；讲解结束后的馆内时间及展品开放以现场为准。'],
['2026-08-05','12:30-13:00（预计）','打车前往五一广场','湖南博物院→五一广场','胡丽霞','预计约20-30分钟，视中午路况与上车点；建议导航“五一广场地铁站/五一广场”。'],
['2026-08-05','13:00-13:45','五一广场精简打卡','五一广场／长沙IFS／黄兴路步行街','胡丽霞','按顺路取舍：五一广场地标→长沙IFS外观（时间允许再上7楼看KAWS雕塑）→黄兴路步行街牌楼；坡子街不强求。13:45必须开始返回酒店。'],
['2026-08-05','13:45-14:05（预计）','返回酒店取行李并退房','五一广场→长沙IFS国金中心·异国印象酒店','胡丽霞','酒店地址：湘江中路2段18号；步行或短途打车预计5-10分钟，预留约10分钟取行李。行李须提前寄存在前台；最晚14:05离开酒店。'],
['2026-08-05','14:05-14:40（预计）','打车前往长沙站','湘江中路2段18号→长沙站','胡丽霞','预计约20-35分钟，视路况；注意车票始发站是“长沙站”，不是长沙南站。建议直接定位长沙火车站进站口。'],
['2026-08-05','14:40-16:20','进站、安检与候车缓冲','长沙站','胡丽霞','为16:55开车预留约2小时15分钟；建议最晚16:20到检票口，实际停止检票时间以车站公告为准。若前段延误，优先取消IFS上楼/缩短五一广场，不能压缩赶车缓冲。'],
...
const isManagedAug5Row=row=>Array.isArray(row)&&row[0]==='2026-08-05'&&(isMawangduiRow(row)||has(row)('五一广场')||has(row)('返回酒店取行李')||has(row)('打车前往长沙站')||has(row)('进站、安检与候车缓冲')||String(row[2]||'').startsWith('C7950'));

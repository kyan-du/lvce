...
export const QIANTANG_TRIP_MIGRATION='qiantang-trip-20260920-v2-plan';
...
export const QIANTANG_NANHU_HOTEL=['嘉兴南湖桔子水晶酒店','2026-09-24','2026-09-25','','九曲路与竹园里交叉口嘉兴辰溪里7…','高级双床房 1间；26㎡；2张1.2*2米床；外景窗；早餐赠1份（限金会员入住）；与另一家嘉兴酒店同夜','1','在线付 ¥322.32'];
export const QIANTANG_ATOUR_HOTEL=['嘉兴月河历史街区中山路亚朵酒店','2026-09-24','2026-09-25','','','携程订单 1128150964876747；房间已预留，到店报住客姓名并出示证件即可入住；入住 14:00后、离店 14:00前；9月24日12:00前免费取消；与另一家嘉兴酒店同夜','1','已授权离店后付 ¥347'];
export const QIANTANG_HANTING_HOTEL=['汉庭海宁盐仓酒店','2026-09-25','2026-09-26','','长安镇农发区锦带湾广场20号1层部…','高级双床房 1间；25-30㎡；2张1.2*2米床；外景窗；早餐赠1份（限金会员入住）；入住 12:00、离店 14:00；9月25日 20:00前可免费取消','1','在线付 ¥315.92'];
export const QIANTANG_ITINERARY_ROWS=[['2026-09-24','17:23-17:53','G1347 上海南→嘉兴南','上海南／嘉兴南','胡丽霞','铁路（4张）；订单号 E292090250；检票口5A5B；下单 2026.09.14。'],['2026-09-24','入住后／晚饭','入住嘉兴南湖桔子水晶酒店','嘉兴南湖桔子水晶酒店','胡丽霞','实际入住南湖桔子水晶，含早餐。月河亚朵同夜订单仍保留，不住。当晚只吃饭，有余力再就近看月河，不排夜游。'],['2026-09-25','上午 约2-2.5小时','南湖环湖并坐船登湖心岛／烟雨楼','嘉兴南湖','胡丽霞','环湖免费；登岛看烟雨楼需现场买往返船票，近年公开价约成人20元上下，儿童规则以码头为准。值得坐船。末班船常见约16:30，以现场为准。'],['2026-09-25','中午','子城过渡','嘉兴子城','胡丽霞','南湖步行约1公里；免费。室内展或周一闭馆则以现场为准，走城垣轮廓即可。'],['2026-09-25','下午','月河历史街区','嘉兴月河','胡丽霞','免费。选一段河、两座桥即可，不按景区清单打卡。预留回酒店取行李和去嘉兴南的时间，衔接 18:02 G7305。不去西塘、乌镇。'],['2026-09-25','18:02-18:17','G7305 嘉兴南→海宁西','嘉兴南／海宁西','胡丽霞','铁路（3张）；胡丽霞、杜万、杜暄妍；杜明远免票随行。订单号 E227044392；检票口二层检票口。海宁西在许村，不是海宁站。'],['2026-09-25','到店后','入住汉庭海宁盐仓酒店','长安镇锦带湾／老盐仓附近','胡丽霞','高级双床房 1间；在线付 ¥315.92。18:17 到海宁西，下午潮基本赶不上；当晚可靠近塘，主场在 26 日白天老盐仓。'],['2026-09-26','白天；提前 60-90 分钟到塘','老盐仓观潮','老盐仓丁字坝','胡丽霞','看一线潮与回头潮。精确来潮钟点以当日海宁潮汛／景区广播为准，不把参考潮时写成列车时刻。不下水、不站丁字坝外侧。带望远镜×2。不去盐官、八堡。'],['2026-09-26','按 19:42 发车倒推','前往海宁站（硖石）','老盐仓→海宁站','胡丽霞','C406 从海宁站发车，不是海宁西。西站（许村）与硖石约 30 公里，不要跑错站。'],['2026-09-26','19:42-20:54','C406 海宁→上海南','海宁／上海南','胡丽霞','铁路（4张）；订单号 E275946591；候车室 01；下单 2026.09.17。']];
export const QIANTANG_TRANSPORT_ROWS=[QIANTANG_G1347_ROW,QIANTANG_G7305_ROW,QIANTANG_C406_ROW];
export const QIANTANG_HOTEL_ROWS=[QIANTANG_NANHU_HOTEL,QIANTANG_ATOUR_HOTEL,QIANTANG_HANTING_HOTEL];
export const QIANTANG_EMERGENCY=[['胡丽霞','186 **** 5057','紧急联系人'],['杜万','185 **** 6420','紧急联系人']];
export const QIANTANG_READINGS=[{id:'jiaxing-nanhu',title:'嘉兴南湖：湖心岛、烟雨楼与红船记忆',venue:'嘉兴南湖',category:'城市湖泊',source:'/assets/readings/jiaxing-nanhu.md'},{id:'jiaxing-yuehe-zicheng',title:'嘉兴子城与月河：城垣、运河与市井街区',venue:'子城／月河',category:'古城街区',source:'/assets/readings/jiaxing-yuehe-zicheng.md'},{id:'laoyancang-tide',title:'老盐仓观潮：丁字坝、一线潮与回头潮',venue:'老盐仓',category:'观潮现场',source:'/assets/readings/laoyancang-tide.md'},{id:'qiantang-tide-cause',title:'钱塘潮成因：喇叭口、沙坎与望朔大潮',venue:'钱塘江／杭州湾',category:'水文科普',source:'/assets/readings/qiantang-tide-cause.md'},{id:'qiantang-tide-literature',title:'观潮诗文：潘阆、周密与苏轼',venue:'钱塘潮文学',category:'历史文献',source:'/assets/readings/qiantang-tide-literature.md'},{id:'yancang-vs-yanguan',title:'盐仓与盐官：两个观潮点，不要走错',venue:'海宁',category:'地点对照',source:'/assets/readings/yancang-vs-yanguan.md'}];
export const QIANTANG_PACKING=[['衣物鞋帽',[['薄外套／防风衣',4],['长袖',4],['长裤',4],['内衣袜子',8],['运动鞋',4],['轻薄雨衣',4]]],['洗护',[['纸巾／湿巾',2],['洗漱用品',4]]],['药品护理',[['常用药',1],['创可贴',1],['降压药',1],['优甲乐',1]]],['证件行程',[['身份证／儿童证件',4],['12306／酒店订单',1]]],['江塘',[['折叠伞',2],['防水袋',2],['水杯',4],['充电宝',2],['坐垫',2],['望远镜',2]]],['数码',[['手机',4],['充电器',2],['充电线',4]]]].map(([name,items],i)=>({id:'qiantang-c'+i,name,items:items.map(([name,qty],j)=>({id:`qiantang-i${i}-${j}`,name,qty,packed:false}))}));
...
function migrateQiantangTrip(trip){
  ...
  const staleNanhuRoom='高级双床房 1间；26㎡；2张1.2*2米床；外景窗；早餐赠1份（限金会员入住）；入住 14:00、离店 14:00；9月24日 20:00前可免费取消；与另一家嘉兴酒店同夜';
  for(const row of next.hotels){if(Array.isArray(row)&&String(row[0]||'')===QIANTANG_NANHU_HOTEL[0]&&row[5]===staleNanhuRoom)row[5]=QIANTANG_NANHU_HOTEL[5]}
  ...
  for(const row of QIANTANG_ITINERARY_ROWS)upsertFillRow(next.itinerary,row,existing=>String(existing?.[0]||'')===row[0]&&String(existing?.[2]||'')===row[2]);
  const staleStay=next.itinerary.findIndex(row=>Array.isArray(row)&&row[0]==='2026-09-24'&&row[2]==='入住嘉兴');
  if(staleStay>=0)next.itinerary.splice(staleStay,1);
  for(const row of QIANTANG_EMERGENCY)upsertFillRow(next.emergency,row,existing=>String(existing?.[0]||'')===row[0]);
  if(!Array.isArray(next.readings)||next.readings.length===0)next.readings=cloneReadings(QIANTANG_READINGS);
  else{
...
export function migrateTripDocument(data){
  ...
  return {data:{...data,trips},changed:true,migrations};
}

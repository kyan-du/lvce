...
export const ZHANGJIAJIE_ITINERARY_MIGRATION='zhangjiajie-itinerary-20260920-v15-rail-sms';
...
export const ZHANGJIAJIE_G1384_SHANGRAO_ROW=['铁路补票（无座）','G1384','列车补票 EBZ6054772；上饶至杭州东；二等座无座；补差价 ¥179','2026-08-10','上饶','','杭州东','','EBZ6054772'];
...
export const ZHANGJIAJIE_G1382_AUG11_ROW=['铁路（1张）','G1382','杜万 购票成功；终点、到达时间、席位、订单号短信未给出','2026-08-11','南昌','07:32','','',''];
...
export const ZHANGJIAJIE_G1384_SHANGRAO_ITINERARY=['2026-08-10','时段短信未给出','G1384 上饶→杭州东（补票无座）','上饶／杭州东','胡丽霞','列车补票 EBZ6054772；二等座无座；补差价 ¥179。开车时刻短信未给出，不猜测。'];
...
export const ZHANGJIAJIE_G1382_AUG11_ITINERARY=['2026-08-11','07:32-待确认','G1382 南昌→待确认','南昌／待确认','杜万','购票成功；终点、到达时间、席位、订单号短信未给出，不猜测。'];

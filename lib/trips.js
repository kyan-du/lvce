...
export const ZHANGJIAJIE_ITINERARY_MIGRATION='zhangjiajie-itinerary-20260805-v10-booking-links';
export const ZHANGJIAJIE_BOOKING_DETAILS=[
  {id:'ticket-mawangdui-20260805',type:'ticket',title:'湖南博物院马王堆讲解预约',match:'湖南省博物馆马王堆基本陈列馆',platform:'未记录',credential:'4人凭身份证；09:00湖南博物院馆外集合',openWith:'待补充'},
  {id:'rail-c7950-20260805',type:'transport',title:'C7950 长沙→张家界西',match:'C7950',platform:'未记录',credential:'乘车人身份证',openWith:'待补充'}
];
export const ZHANGJIAJIE_ITINERARY_LINKS=[
  {date:'2026-08-05',activity:'湖南博物院 3 小时重点游览',bookingId:'ticket-mawangdui-20260805'},
  {date:'2026-08-05',activity:'C7950 长沙→张家界西',bookingId:'rail-c7950-20260805'}
];
...
function migrateZhangjiajieTrip(trip){
  ...
  for(const detail of ZHANGJIAJIE_BOOKING_DETAILS){
    ...
    const hasSource=detail.type==='transport'?next.transport?.some(row=>has(row)(detail.match)):next.tickets?.some(row=>has(row)(detail.match));
